...
writetable(T,'/scratch/gk925/Wendy_brdf_fitting_spray/gloss90_fit/sphere_3params_Conditions.txt','Delimiter','\t')
%% Rendering bit

% Set preferences
setpref('RenderToolbox3', 'workingFolder', '/scratch/gk925/Wendy_brdf_fitting_spray/gloss90_fit');
...
imPath = ['/scratch/gk925/Wendy_brdf_fitting_spray/gloss90_fit/', hints.recipeName, '/renderings/Mitsuba/test_sphere-001.mat']
